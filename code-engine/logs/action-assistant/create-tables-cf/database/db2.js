...
async function insertOnWorkspaceTable(conn, values) {
  var sql = `INSERT INTO CURATOR.WORKSPACES VALUES ('${values.skill.skill_id}','${values.skill.name}','${values.rightInstance.guid}','${values.skill.assistant_id}','${values.skill.environment_id}','${values.rightInstance.account}','${values.rightInstance.credentials[0].credentials.apikey}','${values.rightInstance.credentials[0].credentials.url}');`;
