      ...
      <div className="content">
        ...
        <div id="headMenu">
          ...
          <Search
            ...
            placeholder={Language[language].intentSearch.placeHolder}
            role="searchbox"
            size="lg"
            type="text"
            onKeyDown={(e) => {
          ...
          />
          <Button onClick={() => queryLogs()}>
            {Language[language].intentSearch.btn1}
          </Button>
        </div>
        {logs ? (
          <Stack>
            ...
            {endIndex >= Object.keys(logs).length ? (
              ...
              >
                {Language[language].intentSearch.btn2}
              </Button>
            ) : (
              ""
            )}
          ...
          >
            ...
            >
              ...
              <h3>{Language[language].intentSearch.title}</h3>
            </Stack>
          </div>
        )}
      </div>
